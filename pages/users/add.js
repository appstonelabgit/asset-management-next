            ...
            <form method="post">
                <div className="space-y-12">
                    <div className="border-gray-900/10 border-b pb-12">
                        <h2 className="text-base font-semibold leading-7">Add Users</h2>
                            ...
                            <div className="sm:col-span-3">
                                ...
                                <div className="mt-2">
                                    <input
                                        ...
                                        className="block  w-full rounded-md border-0 py-1.5 shadow-sm ring-1 ring-inset ring-primary focus:ring-2 focus:ring-inset focus:ring-primary sm:text-sm sm:leading-6"
                                    />
                                </div>
                            </div>
                            ...
                            <div className="sm:col-span-3">
                                ...
                                <div className="mt-2">
                                    <select
                                        ...
                                        className="block w-full rounded-md border-0 py-1.5 shadow-sm ring-1 ring-inset ring-primary focus:ring-2 focus:ring-inset focus:ring-primary sm:max-w-xs sm:text-sm sm:leading-6"
                                    >
